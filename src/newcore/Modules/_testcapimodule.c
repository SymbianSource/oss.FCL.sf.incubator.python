...
void thread_cleanup1()
{
       flag1 = 1;
}

void thread_cleanup2()
{
       flag2 = 1;
}

void thread_cleanup3()
{
       flag3 = 1;
}

void thread_cleanup4()
{
       flag4 = 1;
}
...
{
    PyThread_AtExit(thread_cleanup1);
    PyThread_AtExit(thread_cleanup2);
    pthread_exit(0);
    return NULL;
}
...
{
    PyThread_AtExit(thread_cleanup3);
    PyThread_AtExit(thread_cleanup4);
    pthread_exit(0);
    return NULL;
}

static PyObject *
test_thread_exit_func(PyObject *self)
{
    pthread_t new_thread1, new_thread2;
    flag1 = 0, flag2 = 0, flag3 = 0, flag4 = 0;
    
    pthread_create(&new_thread1, NULL, thread_function1, NULL);
    pthread_create(&new_thread2, NULL, thread_function2, NULL);
    ...
    if (flag1 == 1 && flag2 == 1 && flag3 == 1 && flag4 == 1)
	    ...
	    return raiseTestError("test_thread_exit_func",
			"Thread destructor was not called");
}
...
#ifdef WITH_PYTHREAD_ATEXIT	
	{"test_thread_exit_func", (PyCFunction)test_thread_exit_func, METH_NOARGS},
#endif	
