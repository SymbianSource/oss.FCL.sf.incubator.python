...
if sys.platform.startswith("win"):
    tlocs = ("En", "English")
# The locale supported, is specific to the hardware.
# Assume that most of the symbian_s60 devices
# support atleast one of the following locales-
# en_GB.ISO-8859-1(UK English), en_US.UTF-8, en_US.US-ASCII, en_US
# or en_US.ISO-8859-1. If not, fall back to the default locale
# i.e "C"
elif sys.platform == 'symbian_s60':
    tlocs = ("en_GB.ISO-8859-1", "en_US.UTF-8", "en_US.US-ASCII", "en_US", 
            "en_US.ISO-8859-1", "C")
else:
...
try:
    # On Symbian LC_CTYPE category is not supported by OpenC
    if sys.platform == 'sunos5' or sys.platform ==  'symbian_s60':
