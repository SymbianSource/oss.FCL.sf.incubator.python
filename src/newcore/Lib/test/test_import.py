...
def test_with_extension(ext): # ext normally ".py"; perhaps ".pyw"
    ...
    try:
        try:
            ...
            # Generation of .pyc is disabled on Symbian for now
            if sys.platform != 'symbian_s60':
...
# This test does not work on Symbian as py_compile.compile returns MemoryError
# and generation of pyc files is disabled on Symbian due to an inherent problem
if sys.platform != 'symbian_s60':
